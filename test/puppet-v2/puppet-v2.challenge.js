...
describe('[Challenge] Puppet v2', function () {
  ...
  before(async function () {
    ...
    expect(await lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE)).to.eq(
      300000n * 10n ** 18n,
    )
  })
  ...
  it('Execution', async function () {
    ...
    await weth.connect(player).deposit({
      value: await lendingPool.calculateDepositOfWETHRequired(POOL_INITIAL_TOKEN_BALANCE),
    })
