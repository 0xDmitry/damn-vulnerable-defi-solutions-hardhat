...
describe('[Challenge] The rewarder', function () {
  ...
  it('Execution', async function () {
    const TheRewarderAttackFactory = await ethers.getContractFactory('TheRewarderAttack', player)
    const attacker = await TheRewarderAttackFactory.connect(player).deploy(
      rewarderPool.address,
    ...
    await attacker
      .connect(player)
      .attack(flashLoanPool.address, rewardToken.address, TOKENS_IN_LENDER_POOL)
  })
